...
export default function Home() {
  return (
    <div>
      ...
      <body className="flex flex-col bg-gray-50 w-screen h-screen">
        <MainHeader />
        <div className="m-auto text-center w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
          ...
          <div className="lg:mt-0 lg:flex-shrink-0">
            <div className="mt-12 inline-flex rounded-md shadow-lg">
              <button
                type="button"
                className="py-4 px-6 bg-green-600 hover:bg-green-800 text-gray-50 w-full text-center text-base font-semibold shadow-md focus:outline-none rounded-lg "
              >
                Get started
              </button>
            </div>
