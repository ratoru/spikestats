...
export const GroupHeader: React.FC<Props> = ({ groupname, items }) => {
  return (
    <header className="w-full flex px-4 md:px-0 py-4 mb-4 justify-between bg-white shadow rounded-2xl md:bg-transparent md:shadow-none md:rounded-none">
      ...
      <button className="flex items-center px-6 py-2 uppercase font-semibold tracking-wide rounded-full md:shadow bg-green-500 text-white hover:bg-green-600 focus:outline-none">
